    ...
    <div class="overlay-content-wrapper">
      ...
      <svg viewBox="0 0 190 190" height="300px" width="300px" class="svg">
        ...
        <svg
          ...
          width="79.1px"
          height="114px"
          viewBox="0 0 79.1 114"
          style="enable-background:new 0 0 79.1 114;"
          xml:space="preserve"
        >
          <g transform="translate(0.000000, 1.000000)" stroke="#FFFFFF" stroke-width="1.5819">
            <path
              id="loading_page_1_"
              class="st0"
              d="M39.6,0c21.8,0,39.5,4.7,39.5,10.4S61.4,20.8,39.6,20.8S0.1,16.1,0.1,10.4S17.8,0,39.6,0z
        ...
        >
          <g
            ...
            :transform="`rotate(${anim.drum.stick1}) translate(-${anim.drum.stick1Offset}, 0)`"
            transform-origin="30 70"
          >
            <svg
              x="80px"
              y="90px"
              id="DRUM-STICK_Mesa-de-trabajo-1-copia-2_Mesa-de-trabajo-1-copia-2"
              stroke="#FFFFFF"
              stroke-width="1.5819"
              fill-rule="no-zero"
              :fill="currentColor"
            >
              <path
                d="M0.6,0.6 L49.8,49.3 L0.6,0.6 Z M68.9,57.9 C68.9,64.2 63.8,69.4 57.4,69.4 C51,69.4 45.9,64.3 45.9,57.9 C45.9,51.5 51,46.4 57.4,46.4 C63.8,46.4 68.9,51.6 68.9,57.9 Z"
                id="Shape"
              ></path>
            </svg>
          </g>
        ...
        <!-- STICK 2  -->
        <g
          :transform="`rotate(${anim.drum.stick2AdditionalTwirl})`"
          :transform-origin="`0 ${anim.drum.changedTransitionOrigin}`"
        >
          <svg
            width="200px"
            height="300px"
          ...
          >
            <g
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              :transform="`rotate(${anim.drum.stick2})`"
              transform-origin="130 0"
            >
              <svg
                id="DRUM-STICK2_Mesa-de-trabajo-1-copia-2_Mesa-de-trabajo-1-copia-2_Mesa-de-trabajo-1-copia-8"
                stroke="#FFFFFF"
                stroke-width="1.5819"
                fill-rule="no-zero"
                :fill="currentColor1"
              ...
              >
                <path
                  d="M19.6,49.3 L68.8,0.6 L19.6,49.3 Z M12.1,46.4 C18.4,46.4 23.6,51.5 23.6,57.9 C23.6,64.3 18.5,69.4 12.1,69.4 C5.7,69.4 0.6,64.3 0.6,57.9 C0.6,51.5 5.8,46.4 12.1,46.4 Z"
                  id="Shape"
                ></path>
              </svg>
            </g>
